...
# 设置编译选项
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=armv7-a -marm -mfpu=neon -mfloat-abi=hard -Wall -Wundef -finline-functions -finline-limit=64" CACHE STRING "C flags")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv7-a -marm -mfpu=neon -mfloat-abi=hard -Wall -Wundef -finline-functions -finline-limit=64" CACHE STRING "C++ flags")
